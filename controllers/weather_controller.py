...
def get_weather(email):
    ...
    try:
            ...
            data.append(
                {
                    ...
                    "max_temp": response.json()["forecast"]["forecastday"][i]["day"][
                        "maxtemp_c"
                    ],
                    "min_temp": response.json()["forecast"]["forecastday"][i]["day"][
                        "mintemp_c"
                    ],
        ...
        return jsonify(
            {"status": False, "message": "Failed to fetch weather data!", "data": e}
        )
