...
def add_product_to_shop(email):
    ...
    try:
        ...
        if (
            ...
            return jsonify(
                {"status": False, "message": "All fields are required", "data": None}
            ), 400
        ...
        for file in images:
            uploadLink = upload_file(file.filename, "products")
            imagesLinks.append(uploadLink)
        ...
        return jsonify(
            {"status": False, "message": "Product not added", "data": e}
        ), 500
