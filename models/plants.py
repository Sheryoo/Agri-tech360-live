...
def insert_plants_data_from_json(filename):
    ...
    for plant in plants_data:
        ...
        if not existing_plant:
            ...
            plant_image1 = upload_images(Path(f'./models/plants_data/plants_photos1/{plant_name}.png').resolve(),"plants_photos1")
            plant_image2 = upload_images(Path(f'./models/plants_data/plants_photos2/{plant_name}.jpeg').resolve(),"plants_photos2")
